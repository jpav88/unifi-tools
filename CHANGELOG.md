...
### Changed
- **Lucas NanoHD** 5GHz tx_power: `low` → `medium` — improve signal pull for Lucas's iPhone in his room, reduce sticky-client ping-ponging to UDM
- **Lucas iPhone** identified and documented — Fixed private MAC on fish_tank
...
- **Lucas NanoHD**: set min_rssi 5GHz -75, 2.4GHz -70
