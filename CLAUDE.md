...
1. Captures a full baseline (health, iPad state, iPad session history 24h, all AP radio configs) to `snapshots/session_baseline.json`
2. Outputs a 1-line summary with network status, iPad AP/signal, and snapshot path
