...
```json
{"ap_mac": "xx:xx:xx:xx:xx:xx", "signal": -52}
```
...
|---------|-------------|---------|
| `reboot` | Reboot a device | `./scripts/unifi_write.sh reboot xx:xx:xx:xx:xx:xx` |
| `kick` | Disconnect a client | `./scripts/unifi_write.sh kick xx:xx:xx:xx:xx:xx` |
| `block` / `unblock` | Block/unblock a client | `./scripts/unifi_write.sh block xx:xx:xx:xx:xx:xx` |
| `rename` | Set a client's display name | `./scripts/unifi_write.sh rename xx:xx:xx:xx:xx:xx "Living Room TV"` |
...
| `provision` | Force re-provision a device | `./scripts/unifi_write.sh provision xx:xx:xx:xx:xx:xx` |
